...
public class TestTaskOne extends AbstractTest{
    ...
    * */
    ...
    public void testDbConnectionProperties () throws IOException {
        ...
        Pattern urlPattern = Pattern.compile("spring.datasource.url=jdbc:mysql://localhost:3306/assignmentfour");
        ...
        Pattern usernamePattern = Pattern.compile("spring.datasource.username=assignment4");
        ...
        Pattern passwordPattern = Pattern.compile("spring.datasource.password=Learn2Code!");
